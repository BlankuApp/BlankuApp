...
function ReviewerJs(props) {
  ...
  var handleNext = function handleNext() {
    ...
    if (number < 4) {
      ...
      if (hasNext) {
        window.location.href = "/?root=" + root + "&read=" + read + "&order=" + order + "&page=" + (parseInt(page) + 1) + (guestlang ? "&guestLang=" + guestlang : null);
      }
    }
  };
    ...
    React.createElement(
      ...
      root === "home" ? React.createElement(
        ...
        React.createElement(
          "a",
          {
            href: "/?root=" + root + "&read=unread" + "&order=" + order + "&page=" + parseInt(page) + (guestlang != "None" ? "&guestLang=" + guestlang : ""),
        ...
        React.createElement(
          "a",
          {
            href: "/?root=" + root + "&read=readOnly" + "&order=" + order + "&page=" + parseInt(page) + (guestlang != "None" ? "&guestLang=" + guestlang : ""),
        ...
        React.createElement(
          "a",
          {
            href: "/?root=" + root + "&read=all" + "&order=" + order + "&page=" + parseInt(page) + (guestlang != "None" ? "&guestLang=" + guestlang : ""),
      ...
      React.createElement(
        ...
        React.createElement(
          "a",
          {
            href: "/?root=" + root + "&read=" + read + "&order=trikiest" + "&page=" + parseInt(page) + (guestlang != "None" ? "&guestLang=" + guestlang : ""),
        ...
        React.createElement(
          "a",
          {
            href: "/?root=" + root + "&read=" + read + "&order=newest" + "&page=" + parseInt(page) + (guestlang != "None" ? "&guestLang=" + guestlang : ""),
        ...
        React.createElement(
          "a",
          {
            href: "/?root=" + root + "&read=" + read + "&order=oldest" + "&page=" + parseInt(page) + (guestlang != "None" ? "&guestLang=" + guestlang : ""),
        ...
        React.createElement(
          "a",
          {
            href: "/?root=" + root + "&read=" + read + "&order=random" + "&page=" + parseInt(page) + (guestlang != "None" ? "&guestLang=" + guestlang : ""),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(TranslationBox, {
          key: -card.id,
          trans: card.trans,
          dir: userlang === "fa" || userlang === "ar" || guestlang === "fa" || guestlang === "ar" ? "rtl" : "ltr",
          user: username
        })
      ),
      React.createElement(
